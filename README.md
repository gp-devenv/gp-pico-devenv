[![Daily build](https://github.com/gp-devenv/gp-pico-devenv/actions/workflows/dispatch.yaml/badge.svg)](https://github.com/gp-devenv/gp-pico-devenv/actions/workflows/dispatch.yaml)
